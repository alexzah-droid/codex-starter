...
- `SubagentStop` → после каждого субагента: напоминание о цикле commit → SNAPSHOT → integrate
- `PreCompact` → перед compaction: автоматический commit tracked changes + обновление SNAPSHOT timestamp
